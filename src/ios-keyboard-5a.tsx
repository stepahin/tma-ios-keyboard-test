...
function App() {
  ...
  useEffect(() => {
    ...
    if (isIOS) {
      ...
      if (textareaElement) {
        ...
        // Программно управляем анимацией формы вместо CSS
        ...
        textareaElement.addEventListener('focus', () => {
          ...
          // Создаем новый таймер для снятия класса анимации после того, как клавиатура полностью откроется
          keyboardTimer = setTimeout(() => {
            // Когда клавиатура полностью открыта, меняем класс
            document.body.classList.remove('keyboard-opening');
            document.body.classList.add('keyboard-open');
            fixPositioning();
          }, 300); // Время анимации клавиатуры
        });
        ...
        textareaElement.addEventListener('blur', () => {
          ...
          // Добавляем класс для анимации закрытия клавиатуры
          document.body.classList.remove('keyboard-open');
          document.body.classList.add('keyboard-closing');
          
          // Создаем новый таймер для снятия класса анимации после того, как клавиатура полностью закроется
          keyboardTimer = setTimeout(() => {
  ...
  return (
    <div className="app-container">
      ...
      <div className="tool-title">iOS Keyboard 5a</div>
